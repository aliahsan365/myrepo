...
public:
  ...
  void printName() { cout << "Son's Name is " << _name << endl; }

  virtual ~Son() { cout << "Deleting son..." << endl; }
};
...
public:
  ...
  void printName() { cout << "Daugther's Name is " << _name << endl; }
  virtual ~Daugther() { cout << "Deleting Daugther..." << endl; }
};
